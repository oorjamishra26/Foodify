...
public class savour extends AppCompatActivity {
    private final ShoppingCart shoppingCart = new ShoppingCart();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_savour);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(savour.this, Homepage.class);
                startActivity(i);
            }
        });
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Sugar.CartItem item = new Sugar.CartItem("Pav Bhaji", 115);
                shoppingCart.addItem(item);
                Toast.makeText(savour.this, "Item Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Sugar.CartItem item = new Sugar.CartItem("Wada Pav", 50);
                shoppingCart.addItem(item);
                Toast.makeText(savour.this, "Item Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Sugar.CartItem item = new Sugar.CartItem("Dosa", 250);
                shoppingCart.addItem(item);
                Toast.makeText(savour.this, "Item Added", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void openCartActivity() {
        Intent i = new Intent(savour.this, cart.class);
